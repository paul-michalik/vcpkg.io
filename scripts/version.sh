...
[[ ! -v VI_SystemName || -z "${VI_SystemName}" ]] && export VI_SystemName=windows
[[ ! -v VI_Toolset || -z "${VI_Toolset}" ]] && export VI_Toolset=msvc
...
[[ ! -v VI_VcPkgTriplet || -z "${VI_VcPkgTriplet}" ]] && export VI_VcPkgTriplet=${VI_Platform}-${VI_SystemName}
